...
**CRITICAL:** If CONTEXT.md exists from /gbsd:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches GBSD templates)
