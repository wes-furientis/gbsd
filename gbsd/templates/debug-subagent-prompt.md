...
Template for spawning gbsd-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="gbsd-debugger", description="Debug UAT-001")
```
