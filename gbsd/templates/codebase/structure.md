...
│   └── gsd/           # GBSD-specific commands
├── gbsd/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/gbsd/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `gbsd/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `gbsd/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/gbsd/workflows/{name}.md`

**New Reference Document:**
- Implementation: `gbsd/references/{name}.md`
