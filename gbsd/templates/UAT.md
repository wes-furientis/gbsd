...
- This section feeds directly into /gbsd:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /gbsd:plan-phase --gaps with root causes
...
**Creation:** When /gbsd:verify-work starts new session
