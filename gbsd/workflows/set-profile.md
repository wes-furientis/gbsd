<purpose>
Switch the model profile used by GBSD agents. Controls which Claude model each agent uses, balancing quality vs token spend.
</purpose>
...
[Show table from MODEL_PROFILES in gbsd-tools.cjs for selected profile]

Example:
| Agent | Model |
|-------|-------|
| gbsd-planner | opus |
| gbsd-executor | sonnet |
| gbsd-verifier | haiku |
| ... | ... |
