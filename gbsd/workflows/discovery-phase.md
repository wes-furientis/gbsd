...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /gbsd:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/gbsd/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/gbsd/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/gbsd/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/gbsd/templates/discovery.md
...
Use ~/.claude/gbsd/templates/discovery.md.
...
1. Discuss phase context (/gbsd:discuss-phase [current-phase])
2. Create phase plan (/gbsd:plan-phase [current-phase])
