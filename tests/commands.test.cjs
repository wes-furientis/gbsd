...
describe('history-digest command', () => {
  ...
  test('empty phases directory returns valid schema', () => {
    const result = runGbsdTools('history-digest', tmpDir);
...
describe('summary-extract command', () => {
  ...
  test('missing file returns error', () => {
    const result = runGbsdTools('summary-extract .planning/phases/01-test/01-01-SUMMARY.md', tmpDir);
...
`
    ...
    const result = runGbsdTools('summary-extract .planning/phases/01-foundation/01-01-SUMMARY.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
`
    ...
    const result = runGbsdTools('summary-extract .planning/phases/01-foundation/01-01-SUMMARY.md --fields one_liner,key_files,requirements_completed', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('progress command', () => {
  ...
  test('renders JSON progress', () => {
    ...
    const result = runGbsdTools('progress json', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('renders bar format', () => {
    ...
    const result = runGbsdTools('progress bar --raw', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('renders table format', () => {
    ...
    const result = runGbsdTools('progress table --raw', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('does not crash when summaries exceed plans (orphaned SUMMARY.md)', () => {
    ...
    const barResult = runGbsdTools('progress bar --raw', tmpDir);
    ...
    const tableResult = runGbsdTools('progress table --raw', tmpDir);
    assert.ok(tableResult.success, `Table format crashed: ${tableResult.error}`);

    // json format - percent should be clamped
    const jsonResult = runGbsdTools('progress json', tmpDir);
...
describe('todo complete command', () => {
  ...
  test('moves todo from pending to completed', () => {
    ...
    const result = runGbsdTools('todo complete add-dark-mode.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails for nonexistent todo', () => {
    const result = runGbsdTools('todo complete nonexistent.md', tmpDir);
...
describe('scaffold command', () => {
  ...
  test('scaffolds context file', () => {
    ...
    const result = runGbsdTools('scaffold context --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds UAT file', () => {
    ...
    const result = runGbsdTools('scaffold uat --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds verification file', () => {
    ...
    const result = runGbsdTools('scaffold verification --phase 3', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('scaffolds phase directory', () => {
    const result = runGbsdTools('scaffold phase-dir --phase 5 --name User Dashboard', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('generate-slug command', () => {
  ...
  test('converts normal text to slug', () => {
    const result = runGbsdTools('generate-slug "Hello World"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('strips special characters', () => {
    const result = runGbsdTools('generate-slug "Test@#$%^Special!!!"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('preserves numbers', () => {
    const result = runGbsdTools('generate-slug "Phase 3 Plan"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('strips leading and trailing hyphens', () => {
    const result = runGbsdTools('generate-slug "---leading-trailing---"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails when no text provided', () => {
    const result = runGbsdTools('generate-slug', tmpDir);
...
describe('current-timestamp command', () => {
  ...
  test('date format returns YYYY-MM-DD', () => {
    const result = runGbsdTools('current-timestamp date', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('filename format returns ISO without colons or fractional seconds', () => {
    const result = runGbsdTools('current-timestamp filename', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('full format returns full ISO string', () => {
    const result = runGbsdTools('current-timestamp full', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('default (no format) returns full ISO string', () => {
    const result = runGbsdTools('current-timestamp', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('list-todos command', () => {
  ...
  test('empty directory returns zero count', () => {
    const result = runGbsdTools('list-todos', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('area filter returns only matching todos', () => {
    ...
    const result = runGbsdTools('list-todos ui', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('area filter miss returns zero count', () => {
    ...
    const result = runGbsdTools('list-todos nonexistent-area', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('verify-path-exists command', () => {
  ...
  test('existing file returns exists=true with type=file', () => {
    ...
    const result = runGbsdTools('verify-path-exists test-file.txt', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('existing directory returns exists=true with type=directory', () => {
    ...
    const result = runGbsdTools('verify-path-exists test-dir', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('missing path returns exists=false', () => {
    const result = runGbsdTools('verify-path-exists nonexistent/path', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('absolute path resolves correctly', () => {
    ...
    const result = runGbsdTools(`verify-path-exists ${absFile}`, tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails when no path provided', () => {
    const result = runGbsdTools('verify-path-exists', tmpDir);
...
describe('resolve-model command', () => {
  ...
  test('known agent returns model and profile without unknown_agent', () => {
    const result = runGbsdTools('resolve-model gbsd-planner', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('unknown agent returns unknown_agent=true', () => {
    const result = runGbsdTools('resolve-model fake-nonexistent-agent', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('default profile fallback when no config exists', () => {
    ...
    const result = runGbsdTools('resolve-model gbsd-executor', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('fails when no agent-type provided', () => {
    const result = runGbsdTools('resolve-model', tmpDir);
...
describe('commit command', () => {
  ...
  test('skips when commit_docs is false', () => {
    ...
    const result = runGbsdTools('commit "test message"', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('creates real commit with correct hash', () => {
    ...
    const result = runGbsdTools('commit "test: add test file" --files .planning/test-file.md', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
  ...
  test('amend mode works without crashing', () => {
    ...
    const result = runGbsdTools('commit "ignored" --files .planning/amend-file.md --amend', tmpDir);
    assert.ok(result.success, `Command failed: ${result.error}`);
...
describe('websearch command', () => {
  const { cmdWebsearch } = require('../gbsd/bin/lib/commands.cjs');
  let origFetch;
  let origApiKey;
  let origStdoutWrite;
  let captured;
