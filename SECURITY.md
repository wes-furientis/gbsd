...
Instead, please report them via email to: **security@gbsd.build** (or DM @glittercowboy on Discord/Twitter if email bounces)
...
Security issues in the GBSD codebase that could:
